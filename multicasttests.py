...
class MulticastTestCase(unittest.TestCase):
    ...
    def createTestJobs(self):
       ...
       mocks.append(MockJob(199, 'urn:uuid:18ba3287-4b3b-3425-77c3-8d2fea25bffd',
                            ...
                            'gsg8', 1385503803, 1, 'localhost', 'keeper.pl', False, 3))

       mocks.append(MockJob(211, 'urn:uuid:dd314744-71b4-390f-6684-06ac6ad4f2f4',
			    ...
			    'dr2481', 1386955361, 7, 'localhost', '06_Green 2010_Calling all frequent flyers (newnew).ps', False, 3))

       mocks.append(MockJob(212, 'urn:uuid:a77de22c-5ea1-30aa-5275-272e27b0b61d',
			    ...
			    'dr2481', 1387306849, 1, 'localhost', 'Inbox (427) - dr2481@columbia.edu - LionMail Mail', False, 3))
       ...
       mocks.append(MockJob(215, 'urn:uuid:b7fa6482-3ff5-3043-547d-2007c36b2391',
			    ...
			    'dr2481', 1389377472, 2, 'localhost', 'Microsoft.com - Careers', False, 3))
       ...
       mocks.append(MockJob(218, 'urn:uuid:d2b4e7a0-4a43-3509-51b8-5ad94a6c8c76',
			    ...
			    'dr2481', 1389633405, 6, 'localhost', '8.3. struct ? Interpret strings as packed binary data ? Python v2.6.5c2 documentation', False, 3))

       mocks.append(MockJob(219, 'urn:uuid:75ede9c2-6b5a-3f1b-4657-6e9a2ae6da79',
			    ...
			    'dr2481', 1389799822, 4, 'localhost', 'Lesson: Notifications (The Java? Tutorials > Java Management Extensions (JMX))', False, 3))

       mocks.append(MockJob(223, 'urn:uuid:d7a80a3e-ef57-326d-5888-52a5c5d10d30',
			    ...
			    'dr2481', 1389908609, 1, 'localhost', 'New University Policy on Mail and Personal Safety - dr2481@columbia.edu - LionMail Mail', False, 3))
